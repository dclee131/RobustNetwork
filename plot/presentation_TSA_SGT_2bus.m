...
subplot(2,1,1); hold all; box on; grid on; title('(a) System gain')
...
xlabel1=xlabel('$\bar{z}$ (rad)'); ylabel1=ylabel('$\gamma$');  set(xlabel1, 'Interpreter', 'latex'); set(ylabel1, 'Interpreter', 'latex');
legend1=legend('$\gamma_{z,v}$','$\gamma_\psi$','$\gamma_{z,v}\gamma_\psi$','Orientation','horizontal'); 
set(legend1, 'Interpreter', 'latex','FontSize',17,'FontName','Times New Roman');
axis([0 3 0 1.5]);

subplot(2,1,2); hold all; box on; grid on; title('(b) Admissible disturbance bound')
...
set(gca,'FontSize',15,'FontName','Times New Roman'); 
xlabel1=xlabel('$\bar{z}$ (rad)'); ylabel1=ylabel('$\bar{u}$ (p.u.)'); set(xlabel1, 'Interpreter', 'latex'); set(ylabel1, 'Interpreter', 'latex');
legend1=legend('$\gamma_{z,u}\bar{u}<(I-\gamma_{z,v}\gamma_\psi(\bar{z}))\bar{z}$','Simulations','Orientation','horizontal');
...
plot([0 ubar_plot],[0 ybar_plot]/(2*pi),'color',[0 0.4470 0.7410],'LineWidth',2.5)
%scatter(0.435,0.1,50,'r','filled')

set(gca,'FontSize',15,'FontName','Times New Roman'); 
xlabel1=xlabel('$\bar{u}$ (p.u.)'); set(xlabel1, 'Interpreter', 'latex');
ylabel1=ylabel('$\bar{y}$ (Hz)'); set(ylabel1, 'Interpreter', 'latex');
legend1=legend('Linearization','Simulations','$\gamma_{y,u}\bar{u}+\gamma_{y,v}\gamma_\psi(\bar{z})\bar{z}\leq\bar{y}$','Orientation','vertical');
%legend1=legend('Linearization','Simulations','Proposed solution','Orientation','vertical');
set(legend1, 'Interpreter', 'latex','FontSize',15,'FontName','Times New Roman');
%axis([0 0.8 0 0.15]);
axis([0 1 0 0.2]);
return
